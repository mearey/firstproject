...
if (tilemap_get_at_pixel(global.tilemap, bbox_side + hspeed, bbox_top) != 0 or tilemap_get_at_pixel(global.tilemap, bbox_side + hspeed, bbox_bottom) != 0) {
	part_type_orientation(global.deadbulletsmall, image_angle*0.6,image_angle*1.4,random_range(-10,10),0,0)
	part_type_direction(global.deadbulletsmall,image_angle*0.6-180,image_angle*1.4-180,0,0);
	part_particles_create(global.p_system, x, y, global.deadbulletsmall, 1);	
